...
#
# first look in path given by the environment variables (TU Oct-11-2012 )
# HINTS forces find_program to look first in the provided paths
#

find_program(GSL_CONFIG gsl-config NO_SYSTEM_ENVIRONMENT_PATH HINTS $ENV{GSL_DIR}/bin $ENV{GSL_HOME}/bin $ENV{GSLSYS}/bin)

# if this doesn't work out we go to the standard search
# where the system paths are searched first, then the paths
# provided by paths

if(GSL_CONFIG-NOTFOUND)
    FIND_PROGRAM(GSL_CONFIG gsl-config PATHS /usr/bin/ /usr/local/bin/ /opt/bin/)
endif(GSL_CONFIG-NOTFOUND)
